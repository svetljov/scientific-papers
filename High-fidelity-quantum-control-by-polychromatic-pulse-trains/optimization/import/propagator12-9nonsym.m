  ...
  ((-(((1 + \[Epsilon])^2*Abs[o3]*Abs[o4]*
    ...
    ((-(((1 + \[Epsilon])^2*Abs[o5]*Abs[o6]*
      ...
      (((-I)*(1 + \[Epsilon])*Abs[o9]*
         ...
         Sin[Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]/2])/
        Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2] + 
       (((-I)*(1 + \[Epsilon])*Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]*Abs[o7]*
          ...
          ((-I)*(1 + \[Epsilon])*Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]*Abs[o8]*
            ...
            (d8*(1 + \[Epsilon])*Abs[o7] - d7*(1 + \[Epsilon])*Abs[o8])*
             Sin[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2])*
           Sin[Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2])*
         (Cos[Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]/2] + 
          (I*d9*Sin[Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]/2])/
           Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]))/
     ...
     (((-I)*(1 + \[Epsilon])*Sqrt[d6^2 + o6^2*(1 + \[Epsilon])^2]*Abs[o5]*
        ...
        ((-I)*(1 + \[Epsilon])*Sqrt[d5^2 + o5^2*(1 + \[Epsilon])^2]*Abs[o6]*
          ...
          (d6*(1 + \[Epsilon])*Abs[o5] - d5*(1 + \[Epsilon])*Abs[o6])*
           Sin[Sqrt[d5^2 + o5^2*(1 + \[Epsilon])^2]/2])*
         Sin[Sqrt[d6^2 + o6^2*(1 + \[Epsilon])^2]/2])*
       (((-I)*(1 + \[Epsilon])*Abs[o9]*((-I)*(1 + \[Epsilon])*
            Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]*Abs[o7]*
            Cos[Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2]*
            Sin[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2] + 
           ((-I)*(1 + \[Epsilon])*Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]*
              Abs[o8]*Cos[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2] + 
             (-(d8*(1 + \[Epsilon])*Abs[o7]) + d7*(1 + \[Epsilon])*Abs[o8])*
              Sin[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2])*
            Sin[Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2])*
          Sin[Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]/2])/
         (Sqrt[(d7^2 + o7^2*(1 + \[Epsilon])^2)*(d8^2 + 
             o8^2*(1 + \[Epsilon])^2)]*Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^
              2]) + (-(((1 + \[Epsilon])^2*Abs[o7]*Abs[o8]*
             Sin[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2]*
             Sin[Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2])/
            Sqrt[(d7^2 + o7^2*(1 + \[Epsilon])^2)*(d8^2 + o8^2*
                (1 + \[Epsilon])^2)]) + 
     ...
     ((((-I)*(1 + \[Epsilon])*Sqrt[d6^2 + o6^2*(1 + \[Epsilon])^2]*Abs[o5]*
         ...
         ((-I)*(1 + \[Epsilon])*Sqrt[d5^2 + o5^2*(1 + \[Epsilon])^2]*Abs[o6]*
           ...
           (-(d6*(1 + \[Epsilon])*Abs[o5]) + d5*(1 + \[Epsilon])*Abs[o6])*
            Sin[Sqrt[d5^2 + o5^2*(1 + \[Epsilon])^2]/2])*
          Sin[Sqrt[d6^2 + o6^2*(1 + \[Epsilon])^2]/2])*
        (((-I)*(1 + \[Epsilon])*Abs[o9]*(-(((1 + \[Epsilon])^2*Abs[o7]*Abs[
                o8]*Sin[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2]*Sin[
                Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2])/
              Sqrt[(d7^2 + o7^2*(1 + \[Epsilon])^2)*(d8^2 + o8^2*
                  (1 + \[Epsilon])^2)]) + 
            (Cos[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2] - 
              (I*d7*Sin[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2])/Sqrt[
                d7^2 + o7^2*(1 + \[Epsilon])^2])*
             (Cos[Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2] - 
              (I*d8*Sin[Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2])/Sqrt[
         ...
         (((-I)*(1 + \[Epsilon])*Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]*Abs[o7]*
             Cos[Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2]*
             Sin[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2] + 
            ((-I)*(1 + \[Epsilon])*Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]*Abs[
                o8]*Cos[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2] + 
              (d8*(1 + \[Epsilon])*Abs[o7] - d7*(1 + \[Epsilon])*Abs[o8])*Sin[
                Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2])*
             Sin[Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2])*
           (Cos[Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]/2] + 
            (I*d9*Sin[Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]/2])/
             Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]))/
      ...
      ((-(((1 + \[Epsilon])^2*Abs[o5]*Abs[o6]*
       ...
       (((-I)*(1 + \[Epsilon])*Sqrt[d6^2 + o6^2*(1 + \[Epsilon])^2]*Abs[o5]*
         ...
         (((-I)*(1 + \[Epsilon])*Abs[o9]*((-I)*(1 + \[Epsilon])*
            ...
            Sin[Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]/2])/
           (Sqrt[(d7^2 + o7^2*(1 + \[Epsilon])^2)*(d8^2 + o8^2*
                (1 + \[Epsilon])^2)]*Sqrt[d9^2 + o9^2*(1 + \[Epsilon])^2]) + 
          (-(((1 + \[Epsilon])^2*Abs[o7]*Abs[o8]*Sin[
                Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2]*Sin[
                Sqrt[d8^2 + o8^2*(1 + \[Epsilon])^2]/2])/
              Sqrt[(d7^2 + o7^2*(1 + \[Epsilon])^2)*(d8^2 + o8^2*
                  (1 + \[Epsilon])^2)]) + 
            (Cos[Sqrt[d7^2 + o7^2*(1 + \[Epsilon])^2]/2] + 
